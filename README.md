...
All services currently use mock data stored in memory. They simulate API calls with delays.
...
- Mock container data from `mockData.ts`

**enterpriseOwners.service.ts**
- Enterprise owner management
