  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        "accent-outline": "border border-accent/30 text-accent hover:bg-accent/5",
        "time-slot": "border border-border bg-white hover:border-accent/40 hover:bg-accent/5 rounded-lg text-foreground",
        "time-slot-selected": "border border-accent bg-accent/10 text-accent rounded-lg font-medium",
      },
      size: {
